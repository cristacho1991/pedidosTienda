<?php
	...
	if (isset($_GET['id'])){
		...
		$profit=intval($rw_product['profit']);
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-4">
						<div class="input-group">
						  ...
						  <input type="text" class="form-control" id="profit" name="profit" value="<?php echo $profit;?>" required pattern="\d{1,4}"  maxlength="4" onkeyup="precio_venta();">
						</div>
                    </div>
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-4">
						<div class="input-group">
						  ...
						  <input type="text" class="form-control" id="selling_price" name="selling_price" value="<?php echo 	$selling_price;?>"  required pattern="\d+(\.\d{2})?" title="precio con 2 decimales">
						</div>
                    </div>
