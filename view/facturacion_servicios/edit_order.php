    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
		  <h1><i class='fa fa-edit'></i> Editar Factura</h1>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-footer pull-right">
									...
									<button type="button" class='btn btn-default' onclick="orderToPurchase('<?php echo $numfacturacompleta;?>');"> <i class='fa fa-shopping-cart'></i>  FACTURAR</button>
