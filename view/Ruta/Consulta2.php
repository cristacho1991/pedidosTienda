...
<?php
	...
	$sql=mysqli_query($con, " select tclientes.vendedor,rutasv.fecha,tclientes.razonsocia,tclientes.direccion from rutasv inner join tclientes on 
	rutasv.codcliente=tclientes.codcliente and rutasv.empresa=tclientes.empresa and rutasv.sucursal=tclientes.sucursal where codven= $vendedor_id and fecha= '$fecha'");
