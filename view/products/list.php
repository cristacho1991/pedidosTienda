...
<html>
  ...
  <body class="hold-transition <?php echo $skin;?> sidebar-mini">
	...
	function load(page){
		...
		var parametros = {"action":"ajax","page":page,'product_code':product_code,'query':query,'per_page':per_page};
		$("#loader").fadeIn('slow');
		$.ajax({
	...
	function per_page(valor){
		...
		function eliminar(id){
			if(confirm('Esta acción  eliminará de forma permanente el producto \n\n Desea continuar?')){
				...
				var per_page=$("#per_page").val();
				var product_code=$("#product_code").val();
				var parametros = {"action":"ajax","page":page,"query":query,"per_page":per_page,"id":id,"product_code":product_code};
