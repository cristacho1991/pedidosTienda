...
if (isset($_POST['fecha'])){$fecha=$_POST['fecha'];}
	...
	$sql="select DISTINCT detrecimesruta.codcliente ,(select tclientes.longitud from tclientes where tclientes.codcliente=detrecimesruta.codcliente)as longitud,
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		$arreglo_datos=array ('direccion' => $row['razonsocia'] ,'latitud' => $row['latitud'], 'longitud'=> $row['longitud'],'razon'=> $row['razonsocia']);
