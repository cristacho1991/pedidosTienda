    ...
    private function dologinWithPostData()
    {
        ...
        if (empty($_POST['user_name'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $contrasena = $this->db_connection->real_escape_string($_POST['user_password']);
          ...
          $sql = "SELECT * FROM tvendedor
                        WHERE codven = '" . $user_name . "'and password='".$contrasena."'";
               ...
               $result_of_login_check = $this->db_connection->query($sql);
                ...
                if ($result_of_login_check->num_rows == 1) {
                    ...
                    //if (password_verify($_POST['user_password'], $result_row->user_password_hash)) {
                        ...
                        $nombres = $result_row->nombre;
						$_SESSION['name_session']="ispcontrol_admin";
						$_SESSION['nombre'] = $nombres;
						$_SESSION['codven'] = $result_row->codven;
