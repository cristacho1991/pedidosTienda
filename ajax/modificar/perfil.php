    ...
    require_once("../../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['business_name'])){
			...
			// escaping, additionally removing everything that could be (html/javascript-) code
				...
				$skin_id=intval($_POST['theme']);
				// update data
                    $sql = "UPDATE business_profile SET name='".$business_name."', industry='".$industry."', number_id='".$number_id."',email='".$email."',
					phone='".$phone."',tax='".$tax."', currency_id='".$currency."', timezone_id='".$timezone."', address='".$address1."', city='".$city."', state='".$state."',  postal_code='".$postal_code."', country_id='".$country_id."', skin_id='".$skin_id."' WHERE id='1' ";
