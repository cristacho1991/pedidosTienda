...
if($action == 'ajax'){
	...
	$tables="facturas,tclientes,tvendedor";
	...
	$campos="facturas.numerofac, facturas.fecha, tclientes.razonsocia, tclientes.ruc, facturas.vendedor, facturas.anulada,facturas.excentos,facturas.noexcentos, facturas.valoriva";
	...
	$sWhere="facturas.cliente=tclientes.codcliente and facturas.vendedor=tvendedor.codven";
	$sWhere .= " and facturas.fecha between '$fecha_inicial' and '$fecha_final' ";
	
		 //if ($status!=""){
			// $sWhere .= " and facturas.anulada='$status'"; 
		 //}
	$sWhere .= " and tclientes.razonsocia like '%$query%'";	 
	$sWhere.=" order by facturas.numerofac desc";
				...
				<div class="table-responsive">
					<table class="table  table-condensed table-hover table-striped ">
						...
						while($row = mysqli_fetch_array($query)){	
							...
							else if ($status==1) {$estado="Facturada";$label="label-success";}
